        ...
        <div class="card-body">
            ...
            >
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="nome" type="text" class="form-control @error('nome') is-invalid @enderror" name="nome" value="{{ isset($tipoDespesa->nome) ? $tipoDespesa->nome : old('nome') }}" required autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="descricao" type="text" class="form-control @error('descricao') is-invalid @enderror" name="descricao" value="{{ isset($tipoDespesa->descricao) ? $tipoDespesa->descricao : old('descricao') }}">
