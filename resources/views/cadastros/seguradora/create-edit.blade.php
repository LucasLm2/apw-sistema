...
<div class="container bg-white p-5 rounded shadow-sm">
    <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
        @if (request()->routeIs('cadastro.seguradora.edit'))
            <h2 class="h4 fw-bold h2-title-pages"><i class="fa-solid fa-pen-to-square"></i> {{ __('Editar seguradora') }}</h2>
        @else
            <h2 class="h4 fw-bold h2-title-pages"><i class="fa-solid fa-plus"></i> {{ __('Nova seguradora') }}</h2>
        @endif
        <div>
    ...
    >
        ...
        <div class="row mb-3">
            <label for="cnpj" class="col-md-4 col-form-label text-md-end fw-bold">{{ __('CNPJ') }}*</label>
